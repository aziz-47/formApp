    ...
    <div className="d-flex justify-content-center">
      <Card style={{ width: "18rem" }}>
        ...
        <Card.Body>
          ...
          <Card.Text>Reacti ogrenmek baste biraz zormus..</Card.Text>
...
function ConditionalRender() {
  ...
  return (
    <div className="text-center ">
      ...
      {/* Shorcut */}
      {/* 1. degisken true ise 2. calsiri */}
      {goster && <Kart />}

      {/* 1. degisken false ise 2. degsiken calsiir. */}
      {/* {goster || <Kart />} */}
      {!goster && <Footer />}

      {/* Teranary yonetemiyle */}
      {goster ? (
        <div>
          <h1>Kart modulu gozukuyor</h1> <Kart />{" "}
        </div>
      ) : (
        <div>
